...
if __name__ == "__main__":
    ...
    G1 = nx.Graph()
    with open(r'F:\Downloads\Downloads\latex pictures\influence-maximization-master\graphdata\drosophila1.txt') as f:
    ...
    G2 = nx.Graph()
    with open(r'F:\Downloads\Downloads\latex pictures\influence-maximization-master\graphdata\drosophila2.txt') as f:
        n, m = f.readline().split()
        for line in f:
            u, v = map(int, line.split())
            try:
...
#            data[l1[i]]=len(list(set(data1[l1[i]]+data2[l1[i]])))
    ...
    plt.legend([plot[0],plot[1],plot[2],plot[3]],["Degree discount","Random hueristic","S_Maximal cliques","Degree hueristic","generalGreedy"], loc=9)
