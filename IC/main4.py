...
if __name__ == "__main__":
    ...
    fig = plt.figure()
    plot=list()
    algor=[ 'singleDiscount','degreeDiscountIC','find_k_cliques', 'degreeHeuristic','randomHeuristic']
    #
    shape=['^','o','v','o','^']
...
#            data[l1[i]]=len(list(set(data1[l1[i]]+data2[l1[i]])))
    ...
    plt.legend([plot[0],plot[1],plot[2],plot[3],plot[4]],["Degree discount","KSN","SPIN","CIM","HD"], loc=9)
